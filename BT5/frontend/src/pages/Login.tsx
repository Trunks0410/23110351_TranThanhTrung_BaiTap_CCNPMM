      ...
      <main className="flex-grow flex items-center justify-center p-6 mt-10">
        <div className="max-w-6xl w-full flex flex-col md:flex-row gap-8 items-center justify-center">
          ...
          <div className="w-full md:w-1/2 relative">
            <div className="card-brutal p-0 overflow-hidden bg-white aspect-[4/5] relative">
              <img
              ...
              <div className="absolute bottom-10 left-10 right-10 bg-white p-8 border-[3px] border-black shadow-brutal">
                <p className="font-sans font-black italic text-lg mb-4 leading-relaxed tracking-tight">
                  "Công nghệ không chỉ là những thông số kỹ thuật, đó là chìa khóa mở ra tương lai và nâng tầm trải nghiệm sống của bạn."
                </p>
            ...
            <Card className="p-10">
              <div className="mb-10 text-center">
                ...
                <p className="text-gray-600 text-xs font-medium">
                  Chào mừng bạn quay trở lại. Đăng nhập ngay để khám phá những thiết bị công nghệ đỉnh cao.
                </p>
              </div>
